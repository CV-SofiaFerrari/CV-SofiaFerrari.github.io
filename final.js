...
function crearBarra(id_barra){
    ...
    function efectoHabilidades(){
        ...
        if(distancia_skills>=300 && entro==false){
            ...
            const intervalCss = setInterval(function(){
                pintarBarra(css, 9, 1, intervalCss);
            },100);
            const intervalJavascript = setInterval(function(){
                pintarBarra(javascript, 5, 2, intervalJavascript);
            },100);
            const intervalIngles = setInterval(function(){
                pintarBarra(ingles, 7, 3, intervalIngles);
            },100);
        }
    }
    ...
    function pintarBarra(id_barra, cantidad, indice, interval){
        ...
        if(x<cantidad){
            ...
            elementos[x].style.backgroundColor = "#79B969";
        }else{
